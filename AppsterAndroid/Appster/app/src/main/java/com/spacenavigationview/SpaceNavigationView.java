...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private final int centerContentWidth = (int) getResources().getDimension(R.dimen.center_content_width);
    ...
    private void initAndAddViewsToMainView() {
        ...
        centerButton.setCustomSize(centerButtonSize);
        ...
        centerButton.setScaleType(ImageView.ScaleType.CENTER);
...
//                Utils.changeImageViewTint(spaceItemIcon, inActiveSpaceItemColor);
     ...
     * @param spaceItem item to add
     */
    public void addSpaceItem(@HomeNavigation int index, SpaceItem spaceItem) {
        spaceItems.add(index, spaceItem);
    }

    public void addLiveSpaceItem(@HomeNavigation int index, SpaceItem spaceItem) {
     ...
     */
    public void showBadgeAtIndex(@HomeNavigation int itemIndex, int badgeText, @ColorInt int badgeColor) {
