...
import com.appster.profile.UserProfileDetails;
...
public class CustomDialogUtils {
    ...
    public static void showPopUpFollowUnFollow(Context context, final View.OnClickListener clickFollowUnFollow, UserProfileDetails userProfileDetails) {
        if (context != null && !((Activity) context).isFinishing()) {
            final Dialog dialog = new Dialog(context, R.style.Theme_DialogCustom);
            ...
            if (userProfileDetails.getIs_follow() == CommonDefine.USER_PROFILE_UN_FOLLOW) {
                btnClick.setText(context.getString(R.string.pop_up_follow_user));
            } else {
                btnClick.setText(context.getString(R.string.pop_up_unfollow_user));
            }
    ...
    public static void showUserOptionPopUp(Context context, ReportAndBlockCallback callback) {
        if (context != null && !((Activity) context).isFinishing()) {
            ...
            if (loginUser.isDevUser()) {
                dialog.findViewById(R.id.separater_btn_ban).setVisibility(View.VISIBLE);
                Button btnBan = (Button) dialog.findViewById(R.id.btn_ban);
