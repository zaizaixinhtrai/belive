...
import com.pack.utility.AssetsUtil;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    String selectedFontName = "opensansextrabold.ttf";
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tralling_space = a.getFloat(R.styleable.PagerSlidingTabStrip_tralling_space, 0.15f);
        ...
        tabTypeface = AssetsUtil.getFont(getContext(), getContext().getString(R.string.font_helvetica));
