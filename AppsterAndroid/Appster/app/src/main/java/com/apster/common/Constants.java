...
public class Constants {
    ...
    public static final String INSTAGRAM_CLIENT_ID = "eef613968b524f02979b7069297cfd2a";
    public static final String INSTAGRAM_CLIENT_SECRET = "5ba9c9024e8e44e2bea19f19732fdb2f";
    public static final String INSTAGRAM_CALLBACK_URL = "http://belive.sg";
    ...
    public static final int ITEM_PAGE_LIMITED_FOR_GRID = 15;
    ...
    public static final int PICK_VIDEO_REQUEST = 1370;
    public static final int RECORD_VIDEO_REQUEST = 1373;
    public static final int VIDEO_TRIMMED_REQUEST = 1372;
    static final String VIDEO_CACHE_FOLDER = Environment.getExternalStorageDirectory() + File.separator + ".AppstersVideoCachingNew";
    ...
    static final int MAX_VIDEO_CACHE_NUMBER = 10;
    ...
    // Web Url
    public static final String URL_ABOUT_US = "http://belive.sg/streamers";
    public static final String URL_PAYPAL = "https://www.paypal.com/sg/webapps/mpp/account-selection";

    public static final String URL_TERMS_CONDITION = "http://belive.sg/terms";
    ...
    public static final String URL_PRIVACY_POLICY = "http://belive.sg/privacy";
    ...
    // Request code Chating Conversation
    public static final int CONVERSATION_REQUEST = 2004;
    ...
    static final int MAX_IMAGE_SHARE_CACHE_NUMBER = 10;
