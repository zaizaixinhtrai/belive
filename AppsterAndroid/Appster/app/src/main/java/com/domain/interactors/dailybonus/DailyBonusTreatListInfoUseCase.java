...
public class DailyBonusTreatListInfoUseCase extends UseCase<List<DisplayableItem>,Void> {

    private final DailyBonusRepository mBonusTreatListInfoRepository;
    public DailyBonusTreatListInfoUseCase(@NonNull DailyBonusRepository repository, Scheduler uiThread, Scheduler executorThread) {
    ...
    public Observable<List<DisplayableItem>> buildObservable(Void aVoid) {
        return mBonusTreatListInfoRepository.getDailyBonusTreatListInfo();
    }
}
