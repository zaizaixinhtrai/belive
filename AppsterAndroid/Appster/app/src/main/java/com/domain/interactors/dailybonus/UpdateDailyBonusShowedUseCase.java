...
public class UpdateDailyBonusShowedUseCase extends UseCase<Boolean, Void> {
    private final DailyBonusRepository mDailyBonusRepository;

    public UpdateDailyBonusShowedUseCase(@NonNull DailyBonusRepository repository, Scheduler uiThread, Scheduler executorThread) {
    ...
    public Observable<Boolean> buildObservable(Void aVoid) {
        return mDailyBonusRepository.updateDailyDisplayed();
    }
}
