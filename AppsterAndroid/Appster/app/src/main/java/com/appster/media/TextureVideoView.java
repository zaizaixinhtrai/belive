...
import com.appster.customview.ScalableVideo.ScaleManager;
import com.appster.customview.ScalableVideo.Size;
...
//                        getSurfaceTexture().setDefaultBufferSize(mVideoWidth, mVideoHeight);
    ...
    private void scaleVideoSize(int videoWidth, int videoHeight) {
        Log.v("NCS", "videoWidth:" + videoWidth + " videoHeight" + videoHeight);
