...
import static com.appster.utility.ImageLoaderUtil.ScaleType.CENTER_CROP;
import static com.appster.utility.ImageLoaderUtil.ScaleType.CENTER_INSIDE;
import static com.appster.utility.ImageLoaderUtil.ScaleType.FIT_CENTER;
import static com.appster.utility.ImageLoaderUtil.ScaleType.NONE;
...
public class ImageLoaderUtil {
    ...
    private static RequestOptions applyScaleType(@NonNull RequestOptions oldRequest, @ScaleType int scaleType) {
        ...
        if(scaleType==NONE) return requestOptions; //will never happen
        switch (scaleType) {
    ...
    @IntDef({NONE,CENTER_CROP,CENTER_INSIDE,FIT_CENTER})
