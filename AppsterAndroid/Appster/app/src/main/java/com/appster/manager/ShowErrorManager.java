...
public class ShowErrorManager {
    ...
    public static final int pass_word_required = 1501;
    public static final int follow_password_incorrect = 1502;
    public static final int stream_pass_word_required = 1504;
    public static final int stream_pass_incorrect = 1503;
