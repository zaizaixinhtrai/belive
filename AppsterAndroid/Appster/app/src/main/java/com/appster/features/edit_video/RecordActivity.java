...
import com.appster.features.edit_video.filter.ImgFaceunityFilter;
import com.appster.features.edit_video.recordclip.RecordProgressController;
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.click_to_record:
                    if (requestByCode == Constants.RECORD_VIDEO_REQUEST) {
                        onRecordClick();
