...
public class NotificationModel {
    ...
    private int error;
    private List<NotificationEntity> notifiaction;
    ...
    public void setNotifiaction(List<NotificationEntity> notifiaction) {
    ...
    public List<NotificationEntity> getNotifiaction() {
        return notifiaction;
    }
    ...
    public static class NotificationEntity implements Parcelable {
        ...
        public NotificationEntity(NotificationPushModel model) {
            this.setTitle(model.getTitle());
            this.setMessage(model.getMessage());
            this.setPostId(model.getPostId());
            this.setUserId(model.getUserId());
            this.setDisplayName(model.getUserDisplayName());
            this.setGender(model.getGender());
            this.setIsRead(model.isRead());
            this.setNotification_type(model.getNotificationType());
            this.setProfilePic(model.getUserImage());
            this.mPushImageUrl = model.getPushImageUrl();
            this.setThanks_id(model.getThanks_id());
            this.setSlug(model.getSlug());
            this.setPlayUrl(model.getPlayUrl());
