...
public class PhoneSignUpActivity extends BasePhoneSignInActivity implements PhoneSignUpContract.View {
...
//    private static final int MAX_TIMES_RESEND_VERIFICATION_CODE = 2;

    @Bind(R.id.txt_signup_message)
    CustomFontTextView mTxtSignUpMessage;
    @Bind(R.id.txt_country_code)
    CustomFontTextView mTxtCountryCode;
    @Bind(R.id.edt_phone_number)
    CustomFontTextView mEdtPhoneNumber;
    @Bind(R.id.edt_verification_code)
    CustomFontEditText mEdtVerificationCode;
    @Bind(R.id.txt_invalid_message)
    CustomFontTextView mTxtInvalidMessage;
...
//    private int mResendCount;
    ...
    PhoneSignUpContract.UserActions mPresenter;
    ...
    public static Intent createIntent(Context context, Country country, String phoneNumber, String otp){
        ...
        Intent intent = new Intent(context, PhoneSignUpActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPresenter = new PhoneSignUpPresenter();
    ...
    protected int setContentLayout() {
        return R.layout.activity_phone_signup;
    }

    @Override
    protected String setTitle() {
        return getString(R.string.phone_login_signup);
    }

    //======= event handlers =======================================================================
    @OnClick(R.id.btn_resend)
    void onResendButtonClicked(){
//        if (mResendCount > MAX_TIMES_RESEND_VERIFICATION_CODE){
//            Toast.makeText(this, "you can resend the verification only 2 times", Toast.LENGTH_LONG).show();
//            return;
//        }
//        mResendCount++;
    ...
    private void bindView(){
        ...
        mEdtPhoneNumber.setText(mPhoneNumber);

        String phone = mCountry.getDialingCode() + " " + PhoneNumberUtils.formatNumber(mPhoneNumber);
        String mes = String.format(getString(R.string.phone_signup_message), phone);
        mTxtSignUpMessage.setText(mes);
    }
    ...
    private void gotoSetPassWordScreen(){
        startActivity(PhoneSignInNewPasswordActivity.createIntent(this, mCountry, mPhoneNumber));
    }
}
