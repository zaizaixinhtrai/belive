...
public class NotificationPushModel implements Parcelable {
    ...
    // follow iOS to use 'type'
    // don't use 'notificationType' for new push
    @SerializedName("notificationType") @Expose
    ...
    public static final Parcelable.Creator<NotificationPushModel> CREATOR = new Parcelable.Creator<NotificationPushModel>() {
        @Override
