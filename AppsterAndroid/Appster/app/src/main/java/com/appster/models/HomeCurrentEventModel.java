...
public class HomeCurrentEventModel implements Parcelable {
    ...
    private TagListLiveStreamModel Tag;
    ...
    public int getTagId() {
        return Tag!=null?Tag.getTagId():-1;
    }
    ...
    public String getTagImage() {
        return Tag!=null?Tag.getTagImage():"";
    }
    ...
    public static class EventDetailsBean implements Parcelable {
        ...
        public static final Parcelable.Creator<EventDetailsBean> CREATOR = new Parcelable.Creator<EventDetailsBean>() {
            @Override
    ...
    public static final Parcelable.Creator<HomeCurrentEventModel> CREATOR = new Parcelable.Creator<HomeCurrentEventModel>() {
        @Override
