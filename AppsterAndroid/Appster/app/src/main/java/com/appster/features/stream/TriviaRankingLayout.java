...
import com.appster.adapters.RankingListAdapter;
...
public class TriviaRankingLayout extends FrameLayout implements OnLoadMoreListenerRecyclerView {
    ...
    @Bind(R.id.tvNodata)
    TextView tvNodata;
    private RankingListAdapter mTopWinnerAdapter;
    ...
    public TriviaRankingLayout(@NonNull Context context, @Mode int mode,RecyclerItemCallBack<WinnerModel> rankingItemCallback) {
        super(context);
        this.mMode = mode;
    ...
    public TriviaRankingLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public TriviaRankingLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void setAdapter(List<DisplayableItem> listUser) {
        ...
        mTopWinnerAdapter = new RankingListAdapter(new DiffCallBaseUtils(), listUser,mRecyclerItemCallBack);
    ...
    @IntDef({Mode.THIS_WEEK, Mode.ALL_TIME})
