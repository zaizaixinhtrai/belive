...
public class FileImportActivity extends Activity implements
    ...
    private void initBundle() {
        ...
        mFilePath = bundle.getString(Constants.VIDEO_PATH);
        Uri uri = Uri.parse(mFilePath);
        String videoPath = getRealPathFromURI(uri, this);
        initVideo(uri);
    }
    ...
    private void checkPermisson() {
        ...
        if (storagePer != PackageManager.PERMISSION_GRANTED) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                Timber.e( "hasPermission: API version < M");
    ...
    private IMediaPlayer.OnPreparedListener mOnPreparedListener = new IMediaPlayer.OnPreparedListener() {
        ...
        public void onPrepared(IMediaPlayer mp) {
            if (mMediaPlayer != null) {
                Timber.e( "mediaplayer onPrepared");
