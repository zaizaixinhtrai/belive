...
public class ConnectionClassManager {
    ...
    private static final String TAG = ConnectionClassManager.class.getSimpleName();
     ...
     */
  /*package*/ static final int DEFAULT_POOR_BANDWIDTH = 400;
    /*package*/ static final int DEFAULT_MODERATE_BANDWIDTH = 1200;
    ...
    private ExponentialGeometricAverage mUploadBandwidth
    ...
    public synchronized void addBandwidth(long bytes, long timeInMs) {
        ...
        Log.d(TAG, "addBandwidth - bandwidth=" + bandwidth);
    ...
    private boolean significantlyOutsideCurrentBand() {
        if (mUploadBandwidth == null) {
            // Make Infer happy. It wouldn't make any sense to call this while mUploadBandwidth is null.
            return false;
        }
        ...
        double average = mUploadBandwidth.getAverage();
    ...
    public synchronized ConnectionQuality getCurrentBandwidthQuality() {
        ...
        return mapBandwidthQuality(mUploadBandwidth.getAverage());
    }

    private ConnectionQuality mapBandwidthQuality(double average) {
        LogUtils.logE("ConnectionClassManager",String.valueOf(average));
        if (average < 0) {
            return ConnectionQuality.UNKNOWN;
        }
    ...
    public synchronized double getDownloadKBitsPerSecond() {
        return mUploadBandwidth == null
                ? -1.0
                : mUploadBandwidth.getAverage();
    }
