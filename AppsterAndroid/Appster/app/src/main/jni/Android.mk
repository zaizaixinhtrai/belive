...
LOCAL_SRC_FILES := ../jniLibs/$(TARGET_ARCH_ABI)/libHDACEngine.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
# Agora RTC SDK
LOCAL_MODULE := agora-rtc
LOCAL_SRC_FILES := ../jniLibs/$(TARGET_ARCH_ABI)/libagora-rtc-sdk-jni.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := yuv_static
LOCAL_SRC_FILES := ../jniLibs/$(TARGET_ARCH_ABI)/libyuv_static.a
