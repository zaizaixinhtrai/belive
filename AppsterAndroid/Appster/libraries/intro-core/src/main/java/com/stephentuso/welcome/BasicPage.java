...
public class BasicPage extends WelcomePage<BasicPage> {
    ...
    protected boolean showParallax = true;
    protected String headerTypefacePath = null;
    protected String descriptionTypefacePath = null;
    protected int headerColor = WelcomeUtils.NO_COLOR_SET;
    protected int descriptionColor = WelcomeUtils.NO_COLOR_SET;
    ...
    public BasicPage isLastPage(boolean b) {
        this.isLastPage=b;
        return this;
    }
}
